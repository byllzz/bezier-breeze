...
export function Header({ isDark, setIsDark }) {
  return (
    ...
    >
      <h1
        className={`text-2xl font-semibold font-breeze tracking-tight transition-colors bg-gradient-to-r from-green-400 via-purple-500 to-green-400 bg-[length:200%_200%] text-transparent bg-clip-text animate-[gradient_3s_ease_infinite] ${
      ...
      <div className="flex items-center gap-8">
        ...
        <a
          href="https://github.com/byllzz/bezier-breeze"
          target="_blank"
        ...
        {/* Beautiful Minimalist Theme Toggle Button */}
        <button
